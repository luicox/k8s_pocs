...
# 
kubectl create secret generic mysql-credentials --from-literal=username='root' --from-literal=password='root'

curl -X POST http://localhost:8081/transactions      -H "Content-Type: application/json"      -d '{"accountNumber":"1","operationNumber":"0293","amount":"10.04"}'
